...
interface ActivityWebPort {
     ...
     * 훈련 목록 조회
     */
    suspend fun getTrainings(): List<GetTrainingResponse>

    /**
     * 훈련 조회
     */
    @Throws(NotFoundTrainingException::class)
    suspend fun getTraining(trainingCode: String): GetTrainingResponse

    /**
     * 훈련 완료
     */
    @Throws(InvalidTrainingException::class)
    suspend fun training(trainingCode: String, mongId: Long, score: Int): TrainingResponse
}